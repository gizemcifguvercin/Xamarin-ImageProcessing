...
namespace SharedProject
{
    public class Core
    {
        ...
        {
            string emotionKey = "47e3e869da64465d830f821534c843f2";
            ...
            {
                throw new Exception("Yüz Tanıyamadım.");
            }
        ...
        public static string GetHappinessMessage(float score)
        {
            ...
            if (score >= 50)
                return result + " % mutlusun Gülmeye Devam Et!";
            else
                return result + "% :-( mutsuzsun Biraz Neşelen!";
        }
    }
}