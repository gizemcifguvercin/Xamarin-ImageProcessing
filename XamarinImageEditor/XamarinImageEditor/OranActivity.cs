...
{
    [Activity(Label = "OranActivity")]
    public class OranActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            this.SetContentView(Resource.Layout.Oran);
            back = FindViewById<Button>(Resource.Id.btm);
            back.Click += delegate {
        ...
        private void OnActionClick(object sender, EventArgs eventArgs)
        {
            ...
            else
            {
                ...
                _pictureButton.Text = "Fotoðraf Çek";
